...
function ENT:Initialize()
	...
	self.Barrel1:SetPos(self.Entity:GetPos()+self.Entity:GetAngles():Forward()*50+self.Entity:GetAngles():Right()+self.Entity:GetAngles():Up())
	self.Barrel1:SetAngles(Angle(0,0,90))
	self.Barrel1:SetParent(self.Entity)
	...
	self.Barrel2:SetPos(self.Entity:GetPos()+self.Entity:GetAngles():Forward()+self.Entity:GetAngles():Right()*50+self.Entity:GetAngles():Up())
	self.Barrel2:SetAngles(Angle(0,0,90))
	self.Barrel2:SetParent(self.Entity)
