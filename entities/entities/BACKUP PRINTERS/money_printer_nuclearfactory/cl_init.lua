...
function ENT:Draw( bDontDrawModel )
	...
	local TextWidth = surface.GetTextSize("Nuclear Money Factory")
	...
	cam.Start3D2D(Pos + Ang:Up() * 5, Ang, 0.1)
		draw.WordBox(.75, -TextWidth*0.5, -70, "Nuclear Money Factory", "HUDNumber5", Color(204, 151, 24, 155), Color(255,255,255,255))
		draw.WordBox(.75, -TextWidth2*0.5, -24, "Level:"..upgrade, "HUDNumber5", Color(204, 151, 24, 155), Color(255,255,255,255))
