...
function ENT:Draw( bDontDrawModel )
	...
	local TextWidth = surface.GetTextSize("Palladium Money Printer")
	...
	cam.Start3D2D(Pos + Ang:Up() * 13, Ang, 0.2)
		draw.WordBox(.75, -TextWidth*0.5, -70, "Palladium Money Printer", "HUDNumber5", Color(190, 190, 190, 155), Color(255,255,255,255))
