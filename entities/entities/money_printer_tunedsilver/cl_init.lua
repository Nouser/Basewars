...
function ENT:Draw( bDontDrawModel )
	...
	local TextWidth = surface.GetTextSize("Tuned Silver Money Printer")
	...
	cam.Start3D2D(Pos + Ang:Up() * 5, Ang, 0.1)
		draw.WordBox(.75, -TextWidth*0.5, -70, "Tuned Silver Money Printer", "HUDNumber5", Color(230, 232, 250, 155), Color(255,255,255,255))
