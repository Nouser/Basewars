...
// Snipe Shield
	...
	self.SnipeShield1:SetColor(255,255,255,0)
...
// Fuel Tank & Armor
	...
	self.FuelTank1:SetColor(100,100,150,255)
	self.FuelTank1:SetMoveType(MOVETYPE_NONE)
	self.FuelTank1:SetColor(255,255,255,0)
	...
	self.FuelTank2:SetColor(100,100,150,255)
	self.FuelTank2:SetMoveType(MOVETYPE_NONE)
	self.FuelTank2:SetColor(255,255,255,0)
	...
	self.Armor1:SetColor(100,100,150,255)
	self.Armor1:SetMoveType(MOVETYPE_NONE)
	self.Armor1:SetColor(255,255,255,0)
...
// Helmet
	...
	self.Helmet1:SetColor(255,255,255,0)
...
// Scan Blocker & Defusal Kit	
	...
	self.toolkit1:SetColor(100,100,150,255)
	self.toolkit1:SetMoveType(MOVETYPE_NONE)
	self.toolkit1:SetColor(255,255,255,255)
