...
function ENT:Draw( bDontDrawModel )
	...
	local TextWidth = surface.GetTextSize("Tuned Gold Money Printer")
	...
	cam.Start3D2D(Pos + Ang:Up() * 13, Ang, 0.2)
		draw.WordBox(.75, -TextWidth*0.5, -70, "Tuned Gold Money Printer", "HUDNumber5", Color(255, 215, 0, 155), Color(255,255,255,255))
