...
function ENT:Armbomb(planter)
	...
	if (self.Entity:CheckPropFaggotry()==false) then
		...
		timer.Create( tostring(self.Entity) .. "checkpropshit", 10, 5, function() self.PropCheck() end)
		timer.Create( tostring(self.Entity) .. "checkblast", 59, 1, function() self.PropCheck() end)
		timer.Create( tostring(self.Entity) .. "goboom", 60, 1, function() self.Explode() end)
//		timer.Create( tostring(self.Entity) .. "checkpropshit", 10, 5, function() self.PropCheck, self)
//		timer.Create( tostring(self.Entity) .. "checkblast", 59, 1, function() self.PropCheck, self)
//		timer.Create( tostring(self.Entity) .. "goboom", 60, 1, function() self.Explode, self)
