...
function SWEP:DrawHUD()
	...
	if( LocalPlayer():KeyDown(1)) then
			...
			if (trace.Entity:GetNWInt("welddamage")!=nil && trace.HitPos:Distance(LocalPlayer():GetShootPos()) <= 128 and (trace.Entity:GetClass()=="prop_physics_multiplayer" || trace.Entity:GetClass()=="prop_physics_respawnable" || trace.Entity:GetClass()=="prop_physics" || trace.Entity:GetClass()=="phys_magnet" || trace.Entity:GetClass()=="gmod_spawner" || trace.Entity:GetClass()=="gmod_wheel" || trace.Entity:GetClass()=="gmod_thruster" || trace.Entity:GetClass()=="gmod_button" || trace.Entity:GetClass()=="sent_keypad" || trace.Entity:GetClass()=="gmod_light")and trace.Entity:IsValid()) then
			...
			if (trtwo.Entity:GetNWInt("welddamage")!=nil && trtwo.HitPos:Distance(LocalPlayer():GetShootPos()) <= 256 and (trtwo.Entity:GetClass()=="prop_physics_multiplayer" || trtwo.Entity:GetClass()=="prop_physics_respawnable" || trtwo.Entity:GetClass()=="prop_physics" || trtwo.Entity:GetClass()=="phys_magnet" || trtwo.Entity:GetClass()=="gmod_spawner" || trtwo.Entity:GetClass()=="gmod_wheel" || trtwo.Entity:GetClass()=="gmod_thruster" || trtwo.Entity:GetClass()=="gmod_button" || trace.Entity:GetClass()=="sent_keypad" || trace.Entity:GetClass()=="gmod_light")and trtwo.Entity:IsValid()) then
			...
			if (trfour.Entity:GetNWInt("welddamage")!=nil && trfour.HitPos:Distance(LocalPlayer():GetShootPos()) <= 512 and (trfour.Entity:GetClass()=="prop_physics_multiplayer" || trfour.Entity:GetClass()=="prop_physics_respawnable" || trfour.Entity:GetClass()=="prop_physics" || trfour.Entity:GetClass()=="phys_magnet" || trfour.Entity:GetClass()=="gmod_spawner" || trfour.Entity:GetClass()=="gmod_wheel" || trfour.Entity:GetClass()=="gmod_thruster" || trfour.Entity:GetClass()=="gmod_button" || trace.Entity:GetClass()=="sent_keypad" || trace.Entity:GetClass()=="gmod_light")and trfour.Entity:IsValid()) then
			...
			if (trfive.Entity:GetNWInt("welddamage")!=nil && trfive.HitPos:Distance(LocalPlayer():GetShootPos()) <= 768 and (trfive.Entity:GetClass()=="prop_physics_multiplayer" || trfive.Entity:GetClass()=="prop_physics_respawnable" || trfive.Entity:GetClass()=="prop_physics" || trfive.Entity:GetClass()=="phys_magnet" || trfive.Entity:GetClass()=="gmod_spawner" || trfive.Entity:GetClass()=="gmod_wheel" || trfive.Entity:GetClass()=="gmod_thruster" || trfive.Entity:GetClass()=="gmod_button" || trace.Entity:GetClass()=="sent_keypad" || trace.Entity:GetClass()=="gmod_light")and trfive.Entity:IsValid()) then
