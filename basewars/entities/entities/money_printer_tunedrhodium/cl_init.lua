...
function ENT:Draw( bDontDrawModel )
	...
	local TextWidth = surface.GetTextSize("Tuned Rhodium Money Printer")
	...
	cam.Start3D2D(Pos + Ang:Up() * 13, Ang, 0.2)
		draw.WordBox(.75, -TextWidth*0.5, -70, "Tuned Rhodium Money Printer", "HUDNumber5", Color(218, 218, 218, 155), Color(255,255,255,255))
		draw.WordBox(.75, -TextWidth2*0.5, -24, "Level:"..upgrade, "HUDNumber5", Color(218, 218, 218, 155), Color(255,255,255,255))
