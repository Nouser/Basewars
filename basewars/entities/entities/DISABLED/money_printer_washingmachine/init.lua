...
function ENT:Initialize()
	...
	timer.Create( tostring(self.Entity), 25, 0, function() self:giveMoney() end)
	timer.Create( tostring(self.Entity) .. "fuckafkfags", 1000, 1, function() self:shutOff() end)
...
function ENT:Reload()
	...
	timer.Create( tostring(self.Entity) .. "notifyoff", 480, 1, function() self:notifypl() end)
	self.Inactive = false
	self.NearInact = false
