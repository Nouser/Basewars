...
function ENT:Initialize()
	...
	timer.Create( tostring(self.Entity), 23, 0, function() self:giveMoney() end)
	timer.Create( tostring(self.Entity) .. "fuckafkfags", 60, 1, function() self:shutOff() end)
	timer.Create( tostring(self.Entity) .. "notifyoff", 50, 1, function() self:notifypl() end)
