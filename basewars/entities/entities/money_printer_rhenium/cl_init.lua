...
function ENT:Draw( bDontDrawModel )
	...
	local TextWidth = surface.GetTextSize("Rhenium Money Printer")
	...
	cam.Start3D2D(Pos + Ang:Up() * 8.5, Ang, 0.15)
		draw.WordBox(.75, -TextWidth*0.5, -70, "Rhenium Money Printer", "HUDNumber5", Color(190, 190, 190, 155), Color(255,255,255,255))
