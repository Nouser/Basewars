...
SKIN.bg_color 					= Color( 20, 80, 20, 120 )
SKIN.bg_color_sleep 			= Color( 50, 80, 50, 120 )
SKIN.bg_color_dark				= Color( 0, 0, 0, 140 )
SKIN.bg_color_bright			= Color( 70, 100, 70, 140 )

SKIN.bg_alt1 					= Color( 10, 25, 10, 120 )
SKIN.bg_alt2 					= Color( 178, 186, 174, 120 )

SKIN.panel_transback			= Color( 180, 210, 180, 50 )

SKIN.colPropertySheet 			= Color( 100, 130, 100, 140 )
...
SKIN.colButtonBorder			= Color( 20, 80, 20, 255 )
...
function SKIN:PaintButton( panel )
	...
	if panel.m_bBackground then
		if panel:GetDisabled() then
			...
			return
		elseif panel.Depressed || panel:HasFocus() then
		...
		self:DrawFlippedBackground( 0, 0, panel:GetWide(), panel:GetTall(), Color(20,80,20,100) )
	end
end 
...
derma.DefineSkin( "stronghold", "Derma skin that looks cool with a gradient effect", SKIN )