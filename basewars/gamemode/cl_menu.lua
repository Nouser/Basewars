...
function RPDM.MenuGet()
	spawnmenu.AddToolMenuOption("Basewars", "Basewars Settings", "clAllies","Allies","","",RPDM.AllyPanel)
	spawnmenu.AddToolMenuOption("Basewars", "Basewars Settings", "clSettings","Options","","",RPDM.OptionPanel)
end
