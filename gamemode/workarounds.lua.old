...
if CLIENT then
	...
	---------------------------------------------------------------------------*/
	hook.Add("InitPostEntity", "Gamemode_Workarounds", function()
...
---------------------------------------------------------------------------*/
hook.Add("OnEntityCreated", "GM_WireFieldGenerator", function(ent)
	timer.Simple(0, function()
...
Anti crash exploit
---------------------------------------------------------------------------*/
hook.Add("PropBreak", "GM_AntiExploit", function(attacker, ent)
	if IsValid(ent) then
