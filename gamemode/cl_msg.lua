...
local NoticeMaterial = {}
        NoticeMaterial[ 0 ]			= surface.GetTextureID( "gui/silkicons/report" )
        NoticeMaterial[ 1 ]			= surface.GetTextureID( "gui/silkicons/exclamation" )
        NoticeMaterial[ 2 ]			= surface.GetTextureID( "gui/silkicons/money_add" )
        NoticeMaterial[ 3 ]			= surface.GetTextureID( "gui/silkicons/information" )
        NoticeMaterial[ 4 ]			= surface.GetTextureID( "gui/silkicons/error" )
		NoticeMaterial[ 5 ]			= surface.GetTextureID( "gui/silkicons/money_delete" )
...
function MsgManageMessages(msg)
	...
	if LocalPlayer():GetInfoNum("bw_showmessages",1)==nil then
		CreateClientConVar("bw_showmessages", 1, true, false)
	end
	if LocalPlayer():GetInfoNum("bw_shownotify",1)==nil then
		CreateClientConVar("bw_shownotify", 0, true, false)
	end
	if LocalPlayer():GetInfoNum("bw_messages_warningnotify",1)==nil then
		CreateClientConVar("bw_messages_warningnotify", 1, true, false)
	end
	if LocalPlayer():GetInfoNum("bw_messages_dontshowincome",1)==nil then
		CreateClientConVar("bw_messages_dontshowincome", 0, true, false)
	end
	local mode = LocalPlayer():GetInfoNum("bw_showmessages",1)
	local both = LocalPlayer():GetInfoNum("bw_shownotify",1)
	local warn = LocalPlayer():GetInfoNum("bw_messages_warningnotify",1)
	local inc = LocalPlayer():GetInfoNum("bw_messages_dontshowincome",1)
